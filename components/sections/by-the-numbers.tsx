...
export function ByTheNumbers() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden border-b border-bone-100/10 bg-graphite-950 py-12 md:py-32"
    >
      ...
      <div className="container-page relative">
        ...
        />
        <div className="mt-8 grid grid-cols-1 gap-y-0 md:mt-16 md:grid-cols-3 md:gap-x-6 md:gap-y-10 lg:grid-cols-5">
          <StatBlock 
            className="border-t-0 md:border-l-0 md:pl-0"
